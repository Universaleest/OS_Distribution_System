	...
	<script type="text/javascript">
		...
		function selectEvent(selectobj){
			...
			if($("#language option:selected").val() == "kr"){
				...
				window.location.href = "LicenseEditUi.do";
			}
			else{
				window.location.href = "EngLicenseEditUi.do";
...
<body>
	<form id="license-edit-form" action="License-edit-success.do" method="post">
